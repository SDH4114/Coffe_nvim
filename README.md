...
- Адаптивная стартовая страница с крупным логотипом **COFFE** и центрированным меню:
  создать / открыть проект, последние проекты, файлы, поиск текста, настройки и справка.
